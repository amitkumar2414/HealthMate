...
namespace HealthMate.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(WebsiteRoles.Role_Admin).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(WebsiteRoles.Role_Doctor)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(WebsiteRoles.Role_Labotratorist)).GetAwaiter().GetResult();
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.PhoneNumber = Input.PhoneNo;
                user.City = Input.City;
                user.State = Input.State;


                var patient = new HealthMate.Models.Patient
                {
                    Name = Input.Name,
                    Age = Input.Age,
                    Email = Input.Email,
                    ...
                    City = Input.City,
                    State = Input.State,
                    DateOfBirth = DateTime.Now, // Update this as needed
